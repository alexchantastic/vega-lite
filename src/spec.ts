...
export type ExtendedSpec = FacetedCompositeUnitSpec | GenericFacetSpec<CompositeUnitSpec> | GenericLayerSpec<CompositeUnitSpec> | GenericRepeatSpec<CompositeUnitSpec> | GenericVConcatSpec<CompositeUnitSpec> | GenericHConcatSpec<CompositeUnitSpec>;
...
export function normalize(spec: ExtendedSpec | TopLevelExtendedSpec, config: Config): Spec {
  if (isFacetSpec(spec)) {
